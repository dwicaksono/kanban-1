...
exports.default = _default;
        var $a963f1 = exports.default || module.exports;
      
      if (typeof $a963f1 === 'function') {
        $a963f1 = $a963f1.options;
      }
    
        /* template */
        Object.assign($a963f1, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a963f1', $a963f1);
          } else {
            api.reload('$a963f1', $a963f1);
          }
        }
...
var _default = {
  ...
  methods: {
    registerUser: function registerUser() {
      ...
      (0, _axios.default)({
        method: "POST",
        url: "".concat(server, "/users/register"),
        data: {
...
exports.default = _default;
        var $eee9cb = exports.default || module.exports;
      
      if (typeof $eee9cb === 'function') {
        $eee9cb = $eee9cb.options;
      }
    
        /* template */
        Object.assign($eee9cb, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$eee9cb', $eee9cb);
          } else {
            api.reload('$eee9cb', $eee9cb);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"node_modules/parcel/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/mainPage/Navbar.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $6ac8db = exports.default || module.exports;
      
      if (typeof $6ac8db === 'function') {
        $6ac8db = $6ac8db.options;
      }
    
        /* template */
        Object.assign($6ac8db, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("nav", { attrs: { id: "navbar-box" } }, [
    _c("div", { attrs: { id: "logo" } }, [_vm._v("KANBAND")]),
    _vm._v(" "),
    _c(
      "div",
      {
        attrs: { type: "button", id: "logout" },
        on: { click: _vm.logutAction }
      },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6ac8db', $6ac8db);
          } else {
            api.reload('$6ac8db', $6ac8db);
          }
        }
...
var _default = {
  ...
  methods: {
    toFormAdd: function toFormAdd() {
      this.formAdd = true;
    },
    cancelToFormAdd: function cancelToFormAdd() {
      this.formAdd = false;
    },
...
exports.default = _default;
        var $dd38fd = exports.default || module.exports;
      
      if (typeof $dd38fd === 'function') {
        $dd38fd = $dd38fd.options;
      }
    
        /* template */
        Object.assign($dd38fd, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c(
      ...
      [
        _c("div", { attrs: { id: "addBox" } }, [
          _c("div", { attrs: { id: "addBtn" }, on: { click: _vm.toFormAdd } }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dd38fd', $dd38fd);
          } else {
            api.reload('$dd38fd', $dd38fd);
          }
        }
...
exports.default = _default;
        var $5b87f3 = exports.default || module.exports;
      
      if (typeof $5b87f3 === 'function') {
        $5b87f3 = $5b87f3.options;
      }
    
        /* template */
        Object.assign($5b87f3, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5b87f3', $5b87f3);
          } else {
            api.reload('$5b87f3', $5b87f3);
          }
        }
...
var _Login = _interopRequireDefault(require("./components/loginRegister/Login"));

var _Register = _interopRequireDefault(require("./components/loginRegister/Register"));
...
exports.default = _default;
        var $6853bc = exports.default || module.exports;
      
      if (typeof $6853bc === 'function') {
        $6853bc = $6853bc.options;
      }
    
        /* template */
        Object.assign($6853bc, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6853bc', $6853bc);
          } else {
            api.reload('$6853bc', $6853bc);
          }
        }
